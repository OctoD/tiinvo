...
Defined in: [src/filterables.ts:13](https://github.com/OctoD/tiinvo/blob/5dcae37/src/filterables.ts#L13)
...
Defined in: [src/filterables.ts:35](https://github.com/OctoD/tiinvo/blob/5dcae37/src/filterables.ts#L35)
