...
Defined in: [assertables.ts:4](https://github.com/OctoD/tiinvo/blob/2b2bd76/src/assertables.ts#L4)
...
Defined in: [assertables.ts:31](https://github.com/OctoD/tiinvo/blob/2b2bd76/src/assertables.ts#L31)
